...
?>
        ...
        <table class="texto-negrita">
            ...
            echo form_open('venta/procesarCarrito', ['id' => 'carrito_form']); // Deja vacío para enviar al mismo controlador
                $gastos = 0;
                $i = 1;
            ...
            ?>
                ...
                <tr>
                    ...
                    <td colspan="5" align="right">
                        ...
                        <?php if ($id_pedido) { ?>
                            <a href="<?php echo base_url('cancelar_edicion_vta/'.$id_pedido);?>" class="danger" onclick="return confirmarAccionPedido();">
