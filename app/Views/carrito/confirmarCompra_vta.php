...
<div style="width:100%;"align="center">
    <div id="">
        ...
        echo form_open("confirma_compra_vta", ['class' => 'form-signin', 'role' => 'form']);
        ?>
        <br>
        <div align="center">
        ...
        <?php if (!empty($id_pedido)): ?>
            <h3 class="resaltado">
                Modificando Venta Numero: <?php echo htmlspecialchars($id_pedido, ENT_QUOTES, 'UTF-8'); ?>
            </h3>
            <br>
        <?php endif; ?>
            ...
            <a class="btn" href="<?php echo base_url('CarritoList_vta') ?>">Volver</a>
        
            <?php if ($id_cliente) { ?>
                <a href="<?php echo base_url('cancelar_edicion_vta/'.$id_pedido);?>" class="btn danger" onclick="return confirmarAccionPedido();">
...
<script>
    ...
    function confirmarAccionPedido() {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                window.location.href = "<?php echo base_url('cancelar_edicion_vta/'.$id_pedido); ?>";
            }
        });
        return false; // Evita que el enlace siga su curso normal
    }
